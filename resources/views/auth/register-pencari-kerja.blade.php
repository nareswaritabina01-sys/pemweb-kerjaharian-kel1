...
<head>
    ...
    <title>Daftar Pencari Kerja - KerjaHarian</title>
...
<body class="bg-[#f8fafc] text-gray-800 font-sans min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md bg-white border border-gray-200 rounded-3xl p-8 shadow-sm">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Daftar sebagai Pencari Kerja</h1>
            <p class="text-xs text-gray-500 mt-1">Temukan ribuan pekerjaan harian di sekitar Anda.</p>
        </div>

        <form action="{{ route('register.pencari-kerja.process') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <textarea name="alamat" rows="2" placeholder="Alamat domisili"
