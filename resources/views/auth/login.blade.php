...
<body class="bg-[#f8fafc] min-h-screen flex items-center justify-center p-4">
    <div class="bg-white border border-gray-200 rounded-3xl p-8 shadow-sm w-full max-w-md">
        ...
        <form action="{{ route('dashboard') }}" method="GET" class="space-y-4">
            <div>
                <label class="block text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1.5">Alamat Email / No. Telepon</label>
                <div class="relative">
                    <span class="absolute left-4 top-3.5 text-gray-400 text-xs"><i class="fa-solid fa-envelope"></i></span>
                    <input type="text" placeholder="contoh@email.com atau 0812..." class="w-full pl-11 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-[#007A87] focus:bg-white transition" required>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="password" placeholder="••••••••" class="w-full pl-11 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-[#007A87] focus:bg-white transition" required>
                </div>
            </div>

            <div class="flex items-center pt-1">
                <input type="checkbox" id="remember" class="w-4 h-4 text-[#007A87] border-gray-300 rounded focus:ring-[#007A87] bg-gray-50">
        ...
        <div class="text-center mt-8 pt-6 border-t border-gray-100">
            <p class="text-xs text-gray-500">Belum punya akun KerjaHarian? <a href="#" class="font-bold text-[#007A87] hover:underline">Daftar Sekarang</a></p>
        </div>
    </div>
</body>
</html>